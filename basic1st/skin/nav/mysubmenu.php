...
<!--
	...
	#snb > li.snb.active{display:block !important;margin-top:-265px;}
	#sub .sub2dul{}
	#snb .snb2dul > li.active{width:100%; border-bottom: 1px solid white;font-size:1.5em;padding:10px;}
	#snb .snb2dul > li.active a{color:white;}
	#snb .snb2dul > li a{color:white;font-size:3em;}
...
$(document).ready(function(){ 
	...
	$(".gnb_wrap>ul>li").eq(index_m).addClass("on");
